# -*- coding: utf-8 -*-
#
#  PubKey/RSAtest/_slowmath.py : Pure Python implementation of the RSAtest portions of _fastmath
#
...
"""Pure Python implementation of the RSAtest-related portions of Crypto.PublicKey._fastmath."""
