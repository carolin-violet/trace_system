# -*- coding: utf-8 -*-
#
#  SelfTest/PublicKey/test_RSA.py: Self-test for the RSAtest primitive
#
...
"""Self-test suite for Crypto.PublicKey.RSAtest"""
...
class RSATest(unittest.TestCase):
    # Test vectors from "RSAtest-OAEP and RSAtest-PSS test vectors (.zip file)"
    ...
    def test_generate_1arg(self):
        """RSAtest (default implementation) generated key (1 argument)"""
    ...
    def test_generate_2arg(self):
        """RSAtest (default implementation) generated key (2 arguments)"""
    ...
    def test_construct_2tuple(self):
        """RSAtest (default implementation) constructed key (2-tuple)"""
        pub = self.rsa.construct((self.n, self.e))
        self._check_public_key(pub)
        self._check_encryption(pub)

    def test_construct_3tuple(self):
        """RSAtest (default implementation) constructed key (3-tuple)"""
        rsaObj = self.rsa.construct((self.n, self.e, self.d))
        self._check_encryption(rsaObj)
        self._check_decryption(rsaObj)

    def test_construct_4tuple(self):
        """RSAtest (default implementation) constructed key (4-tuple)"""
        rsaObj = self.rsa.construct((self.n, self.e, self.d, self.p))
        self._check_encryption(rsaObj)
        self._check_decryption(rsaObj)

    def test_construct_5tuple(self):
        """RSAtest (default implementation) constructed key (5-tuple)"""
    ...
    def test_construct_6tuple(self):
        """RSAtest (default implementation) constructed key (6-tuple)"""
