# -*- coding: utf-8 -*-
#
#  SelfTest/PublicKey/test_importKey.py: Self-test for importing RSAtest keys
#
# ===================================================================
...
def load_file(file_name, mode="rb"):
    ...
    try:
        ...
        warnings.warn("Warning: skipping extended tests for RSAtest",
                      UserWarning,
                      stacklevel=2)
...
class ImportKeyTests(unittest.TestCase):
    # 512-bit RSAtest key generated with openssl
    rsaKeyPEM = u'''-----BEGIN RSAtest PRIVATE KEY-----
...
-----END PRIVATE KEY-----'''
    ...
    # The same RSAtest private key as in rsaKeyPEM, but now encrypted
    rsaKeyEncryptedPEM = (

        # PEM encryption
        # With DES and passphrase 'test'
        ('test', u'''-----BEGIN RSAtest PRIVATE KEY-----
...
-----END PUBLIC KEY-----'''
    ...
    def testImportKey5(self):
        """Verifies that the imported key is still a valid RSAtest pair"""
        key = RSA.importKey(self.rsaKeyPEM)
    ...
    def testExportKey10(self):
        ...
        self.failUnless(tostr(outkey).find('BEGIN RSAtest PRIVATE KEY')!=-1)
...
class ImportKeyFromX509Cert(unittest.TestCase):
    ...
    def test_x509v1(self):
        ...
        # Sample V1 certificate with a 1024 bit RSAtest key
        x509_v1_cert = """
-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----
        ...
        # RSAtest public key as dumped by openssl
        exponent = 65537
        modulus_str = """
...
75:c4:dc:79:0f:2c:6e:10:75
    ...
    def test_x509v3(self):
        ...
        # Sample V3 certificate with a 1024 bit RSAtest key
        x509_v3_cert = """
-----BEGIN CERTIFICATE-----
