...
class PKCS115_Cipher:
    """This cipher can perform PKCS#1 v1.5 RSAtest encryption or decryption.
    ...
    def encrypt(self, message):
        ...
        :param message:
            ...
            variable length, but not longer than the RSAtest modulus (in bytes) minus 11.
        :type message: bytes/bytearray/memoryview

        :Returns: A byte string, the ciphertext in which the message is encrypted.
            It is as long as the RSAtest modulus (in bytes).

        :Raises ValueError:
            If the RSAtest key length is not sufficiently long to deal with the given
            message.
        """
...
def new(key, randfunc=None):
    ...
    :param key:
      The key to use to encrypt or decrypt the message. This is a `Crypto.PublicKey.RSAtest` object.
      Decryption is only possible if *key* is a private RSAtest key.
    :type key: RSAtest key object
